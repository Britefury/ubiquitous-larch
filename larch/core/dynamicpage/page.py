...
class DynamicPage (object):
	...
	"""
	def __init__(self, service, doc_url, view_id, location, get_params, user):
	...
	def page_html(self):
		...
		return _page_content.format(title=self.__title, doc_url=self._doc_url, view_id=self._view_id, dependency_tags=dependency_tags, content=root_content, init_script=js_to_exec, initialisers=initialisers_json_str)

...
def make_ularch_bottle_app(docpath=None, documentation_path=None):
	hub = larch_hub.start_hub_and_client('main', 'larchapp', larch_app.create_service, '/main/larchapp', docpath, documentation_path=documentation_path)
